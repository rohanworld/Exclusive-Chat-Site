window.onload = function() {
  ...
  class MEME_CHAT{
    ...
    create_join_form(){
      ...
      join_input.setAttribute('maxlength', 3)
      join_input.placeholder = 'Passcode'
      join_input.onkeyup  = function(){
        if(join_input.value.length == 3 && (join_input.value=='000' || join_input.value=='017' || join_input.value=='975' || join_input.value=='312' || join_input.value=='224' || join_input.value=='607')){
